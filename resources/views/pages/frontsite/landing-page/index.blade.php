          ...
          <div class="row">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-12">
                    <div class="border-first-button scroll-to-section">
                      <a href="janji_temu.html">Get Started</a>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-lg-6">
              <div class="right-image wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
                <img src="assets/images/queue.png" alt="">
              </div>
            </div>
          </div>
        </div>
                    ...
                    <div class="col-lg-4">
                      <div class="info-post">
                        <div class="icon">
                          ...
                          <a href="https://dinkes.sumselprov.go.id/">Website Resmi</a>
                        </div>
                      </div>
                    </div>
                    <div class="col-lg-8">
                      <div class="info-post">
                        <div class="icon">
                          ...
                          <a href="https://goo.gl/maps/Rn7HRM7sMqYV4qp7A">Jalan Dokter Muhammad Ali No.KM 3, RW.5, Pahlawan, Kec. Kemuning, Kota Palembang, Sumatera Selatan 30114</a>
                        </div>
                      </div>
                    </div>
                    </div>
